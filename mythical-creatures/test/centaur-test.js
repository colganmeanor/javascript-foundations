...
describe('Centaur', function() {
  ...
  it('should be able to be named whatever the hell you want', function() {
    var centaur1 = new Centaur({ name: 'Colgan' });
    var centaur2 = new Centaur({ name: 'Christina'});

    assert.equal(centaur1.name, 'Colgan');
    assert.equal(centaur2.name, 'Christina');
