...
describe('Medusa', function() {
  ...
  it('should accept an argument for name', function() {
    var medusa1 = new Medusa('Colgan');
    var medusa2 = new Medusa('Christina');

    assert.equal(medusa1.name, 'Colgan');
    assert.equal(medusa2.name, 'Christina');
